      ...
      if(p_516_4_ <= 4) {
            ...
            for(var32 = 0; var32 < 16; ++var32) {
               for(var10 = 4; var10 < 8; ++var10) {
                  if(var6[(var8 * 16 + var32) * 8 + var10] && p_516_1_.func_600_a(p_516_3_ + var8, p_516_4_ + var10 - 1, p_516_5_ + var32) == Block.field_336_w.field_376_bc && p_516_1_.func_641_a(EnumSkyBlock.Sky, p_516_3_ + var8, p_516_4_ + var10, p_516_5_ + var32) > 0) {
                     BiomeGenBase var35 = p_516_1_.func_48454_a(p_516_3_ + var8, p_516_5_ + var32);
                     if(var35.field_4242_o == Block.field_40199_bz.field_376_bc) {
         ...
         if(Block.field_345_n[this.field_15235_a].field_356_bn == Material.field_1332_f) {
            for(var8 = 0; var8 < 16; ++var8) {
               for(var32 = 0; var32 < 16; ++var32) {
                  byte var34 = 4;
                  if(p_516_1_.func_40471_p(p_516_3_ + var8, p_516_4_ + var34, p_516_5_ + var32)) {
                     p_516_1_.func_634_a(p_516_3_ + var8, p_516_4_ + var34, p_516_5_ + var32, Block.field_4063_aU.field_376_bc);
                  }
               }
            }
         }
