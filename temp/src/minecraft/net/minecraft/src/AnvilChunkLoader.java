...
public class AnvilChunkLoader implements IThreadedFileIO, IChunkLoader {
   ...
   private void func_48445_a(Chunk p_48445_1_, World p_48445_2_, NBTTagCompound p_48445_3_) {
      ...
      if(var18 != null) {
         long var20 = p_48445_2_.func_22139_r();
         ...
         while(var12.hasNext()) {
            ...
            var14.func_758_a("t", (int)(var13.field_1364_e - var20));
   ...
   private Chunk func_48444_a(World p_48444_1_, NBTTagCompound p_48444_2_) {
      ...
      if(var14 != null) {
         for(int var17 = 0; var17 < var14.func_740_c(); ++var17) {
            NBTTagCompound var16 = (NBTTagCompound)var14.func_741_a(var17);
            Entity var18 = EntityList.func_1081_a(var16, p_48444_1_);
            var5.field_1523_r = true;
            if(var18 != null) {
               var5.func_1000_a(var18);
            }
         }
      }

      NBTTagList var15 = p_48444_2_.func_753_l("TileEntities");
      if(var15 != null) {
         for(int var21 = 0; var21 < var15.func_740_c(); ++var21) {
            NBTTagCompound var20 = (NBTTagCompound)var15.func_741_a(var21);
            TileEntity var13 = TileEntity.func_477_c(var20);
            if(var13 != null) {
      ...
      if(p_48444_2_.func_751_b("TileTicks")) {
         NBTTagList var19 = p_48444_2_.func_753_l("TileTicks");
         if(var19 != null) {
            for(int var22 = 0; var22 < var19.func_740_c(); ++var22) {
               NBTTagCompound var23 = (NBTTagCompound)var19.func_741_a(var22);
