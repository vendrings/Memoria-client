   ...
   public void func_28136_a(EntityPlayer p_28136_1_, int p_28136_2_, int p_28136_3_, int p_28136_4_, int p_28136_5_, int p_28136_6_) {
      ...
      case 2003:
         ...
         for(double var38 = 0.0D; var38 < 6.283185307179586D; var38 += 0.15707963267948966D) {
            this.func_939_a("portal", var33 + Math.cos(var38) * 5.0D, var10 - 0.4D, var12 + Math.sin(var38) * 5.0D, Math.cos(var38) * -5.0D, 0.0D, Math.sin(var38) * -5.0D);
            this.func_939_a("portal", var33 + Math.cos(var38) * 5.0D, var10 - 0.4D, var12 + Math.sin(var38) * 5.0D, Math.cos(var38) * -7.0D, 0.0D, Math.sin(var38) * -7.0D);
         }
