...
public class GuiIngame extends Gui {
   ...
   public void func_4066_a(float p_4066_1_, boolean p_4066_2_, int p_4066_3_, int p_4066_4_) {
      ...
      if(!this.field_9422_g.field_6327_b.func_35643_e()) {
         ...
         if(this.field_9422_g.field_6327_b.func_6469_d()) {
            ...
            for(var25 = 0; var25 < 10; ++var25) {
               ...
               var29 = var46;
               if(var12 <= 4) {
                  var29 = var46 + this.field_9423_f.nextInt(2);
               }
            ...
            for(var25 = 0; var25 < 10; ++var25) {
               ...
               if(this.field_9422_g.field_6322_g.func_35191_at().func_35760_d() <= 0.0F && this.field_9421_h % (var16 * 3 + 1) == 0) {
                  var26 = var46 + (this.field_9423_f.nextInt(3) - 1);
               }
      ...
      if(this.field_9422_g.field_6327_b.func_35642_f() && this.field_9422_g.field_6322_g.field_35210_aY > 0) {
         ...
         String var37 = "" + this.field_9422_g.field_6322_g.field_35210_aY;
         var40 = (var6 - var8.func_871_a(var37)) / 2;
         var39 = var7 - 31 - 4;
         var8.func_873_b(var37, var40 + 1, var39, 0);
         var8.func_873_b(var37, var40 - 1, var39, 0);
         var8.func_873_b(var37, var40, var39 + 1, 0);
         var8.func_873_b(var37, var40, var39 - 1, 0);
         var8.func_873_b(var37, var40, var39, var12);
      }
      ...
      if(this.field_9422_g.field_6304_y.field_22276_A) {
         ...
         var46 = MathHelper.func_1108_b(this.field_9422_g.field_6322_g.field_611_ak);
         ...
         if(this.field_9422_g.field_6324_e != null && this.field_9422_g.field_6324_e.func_630_d(var46, var22, var23)) {
            Chunk var47 = this.field_9422_g.field_6324_e.func_673_a(var46, var23);
            this.func_547_b(var8, "lc: " + (var47.func_48498_h() + 15) + " b: " + var47.func_48490_a(var46 & 15, var23 & 15, this.field_9422_g.field_6324_e.func_4075_a()).field_6504_m + " bl: " + var47.func_1025_a(EnumSkyBlock.Block, var46 & 15, var22, var23 & 15) + " sl: " + var47.func_1025_a(EnumSkyBlock.Sky, var46 & 15, var22, var23 & 15) + " rl: " + var47.func_1019_c(var46 & 15, var22, var23 & 15, 0), 2, 96, 14737632);
         }
      ...
      if(this.field_9422_g.field_6322_g instanceof EntityClientPlayerMP && this.field_9422_g.field_6304_y.field_35384_x.field_35965_e) {
         NetClientHandler var36 = ((EntityClientPlayerMP)this.field_9422_g.field_6322_g).field_797_bg;
         List var35 = var36.field_35786_c;
         var13 = var36.field_35785_d;
         var40 = var13;
         ...
         byte var43 = 10;
         func_551_a(var17 - 1, var43 - 1, var17 + var16 * var39, var43 + 9 * var40, Integer.MIN_VALUE);

         for(var19 = 0; var19 < var13; ++var19) {
            var20 = var17 + var19 % var39 * var16;
            var46 = var43 + var19 / var39 * 9;
            func_551_a(var20, var46, var20 + var16 - 1, var46 + 8, 553648127);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            GL11.glEnable(3008);
            if(var19 < var35.size()) {
               GuiPlayerInfo var45 = (GuiPlayerInfo)var35.get(var19);
               var8.func_50103_a(var45.field_35624_a, var20, var46, 16777215);
               this.field_9422_g.field_6315_n.func_1076_b(this.field_9422_g.field_6315_n.func_1070_a("/gui/icons.png"));
               byte var50 = 0;
               boolean var48 = false;
               byte var49;
               if(var45.field_35623_b < 0) {
                  var49 = 5;
               } else if(var45.field_35623_b < 150) {
                  var49 = 0;
               } else if(var45.field_35623_b < 300) {
                  var49 = 1;
               } else if(var45.field_35623_b < 600) {
                  var49 = 2;
               } else if(var45.field_35623_b < 1000) {
                  var49 = 3;
               } else {
                  var49 = 4;
               }
               ...
               this.func_550_b(var20 + var16 - 12, var46, 0 + var50 * 10, 176 + var49 * 8, 10, 8);
               this.field_923_k -= 100.0F;
            }
         }
      }
   ...
   private void func_50010_a(FontRenderer p_50010_1_) {
      ...
      if(var5 > 0) {
         ...
         if(var3) {
            ...
            int var16 = this.field_50017_n * var14 / var5;
            int var9 = var14 * var14 / var6;
            if(var6 != var14) {
               var10 = var16 > 0?170:96;
               int var15 = this.field_50018_o?13382451:3355562;
               func_551_a(0, -var16, 2, -var16 - var9, var15 + (var10 << 24));
               func_551_a(2, -var16, 1, -var16 - var9, 13421772 + (var10 << 24));
            }
         }
