...
public class RenderMinecart extends Render {
   ...
   public void func_152_a(EntityMinecart p_152_1_, double p_152_2_, double p_152_4_, double p_152_6_, float p_152_8_, float p_152_9_) {
      ...
      float var30 = (float)p_152_1_.func_41025_i() - p_152_9_;
      if(var30 < 0.0F) {
         var30 = 0.0F;
      }

      if(var28 > 0.0F) {
         GL11.glRotatef(MathHelper.func_1106_a(var28) * var28 * var30 / 10.0F * (float)p_152_1_.func_41030_m(), 1.0F, 0.0F, 0.0F);
      }
