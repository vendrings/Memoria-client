...
public class EntityRenderer {
   ...
   public void func_4134_c(float p_4134_1_, long p_4134_2_) {
      ...
      for(int var19 = 0; var19 < 2; ++var19) {
         ...
         this.func_4139_a(p_4134_1_, var19);
         ...
         var18.func_343_a(var7, var9, var11);
         this.field_1388_h.field_6323_f.func_960_a(var18, p_4134_1_);
         if(var19 == 0) {
            Profiler.func_40661_c("updatechunks");

            while(!this.field_1388_h.field_6323_f.func_948_a(var4, false) && p_4134_2_ != 0L) {
               long var21 = p_4134_2_ - System.nanoTime();
         ...
         if(this.field_35823_q == 0) {
            ...
            var5.func_951_a(var4.func_427_e(p_4134_1_), var18, p_4134_1_);
            ...
            if(this.field_1388_h.field_6305_x != null && var4.func_393_a(Material.field_1332_f) && var4 instanceof EntityPlayer && !this.field_1388_h.field_6304_y.field_22277_y) {
               ...
               var5.func_959_a(var20, this.field_1388_h.field_6305_x, 0, var20.field_778_b.func_494_a(), p_4134_1_);
               var5.func_955_b(var20, this.field_1388_h.field_6305_x, 0, var20.field_778_b.func_494_a(), p_4134_1_);
               GL11.glEnable(3008);
            }
         }
         ...
         if(this.field_21155_l == 1.0D) {
            GL11.glClear(256);
            this.func_4135_b(p_4134_1_, var19);
         }
