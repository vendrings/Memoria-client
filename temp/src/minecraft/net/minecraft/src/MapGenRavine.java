...
public class MapGenRavine extends MapGenBase {
   ...
   protected void func_35626_a(long p_35626_1_, int p_35626_3_, int p_35626_4_, byte[] p_35626_5_, double p_35626_6_, double p_35626_8_, double p_35626_10_, float p_35626_12_, float p_35626_13_, float p_35626_14_, int p_35626_15_, int p_35626_16_, double p_35626_17_) {
      ...
      for(; p_35626_15_ < p_35626_16_; ++p_35626_15_) {
         double var53 = 1.5D + (double)(MathHelper.func_1106_a((float)p_35626_15_ * 3.1415927F / (float)p_35626_16_) * p_35626_12_ * 1.0F);
         double var30 = var53 * p_35626_17_;
         ...
         if(var54 || var19.nextInt(4) != 0) {
            ...
            if(p_35626_6_ >= var20 - 16.0D - var53 * 2.0D && p_35626_10_ >= var22 - 16.0D - var53 * 2.0D && p_35626_6_ <= var20 + 16.0D + var53 * 2.0D && p_35626_10_ <= var22 + 16.0D + var53 * 2.0D) {
               int var56 = MathHelper.func_1108_b(p_35626_6_ - var53) - p_35626_3_ * 16 - 1;
               int var35 = MathHelper.func_1108_b(p_35626_6_ + var53) - p_35626_3_ * 16 + 1;
               int var55 = MathHelper.func_1108_b(p_35626_8_ - var30) - 1;
               int var37 = MathHelper.func_1108_b(p_35626_8_ + var30) + 1;
               int var57 = MathHelper.func_1108_b(p_35626_10_ - var53) - p_35626_4_ * 16 - 1;
               int var39 = MathHelper.func_1108_b(p_35626_10_ + var53) - p_35626_4_ * 16 + 1;
               if(var56 < 0) {
                  var56 = 0;
               }
               ...
               if(!var58) {
                  for(var41 = var56; var41 < var35; ++var41) {
                     double var59 = ((double)(var41 + p_35626_3_ * 16) + 0.5D - p_35626_6_) / var53;

                     for(var44 = var57; var44 < var39; ++var44) {
                        double var45 = ((double)(var44 + p_35626_4_ * 16) + 0.5D - p_35626_10_) / var53;
