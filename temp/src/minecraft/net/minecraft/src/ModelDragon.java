...
public class ModelDragon extends ModelBase {
   ...
   public void func_864_b(Entity p_864_1_, float p_864_2_, float p_864_3_, float p_864_4_, float p_864_5_, float p_864_6_, float p_864_7_) {
      ...
      this.field_40314_a.field_1406_e = this.func_40307_a(var23[0] - var15[0]) * 3.1415927F / 180.0F * 1.0F;
      this.field_40314_a.field_1405_f = -this.func_40307_a(var23[0] - (double)var17) * 3.1415927F / 180.0F * 1.0F;
      ...
      for(int var25 = 0; var25 < 12; ++var25) {
         var23 = var8.func_40160_a(12 + var25, this.field_40317_s);
         var24 = (float)((double)var24 + Math.sin((double)((float)var25 * 0.45F + var18)) * 0.05000000074505806D);
         this.field_40312_b.field_1406_e = (this.func_40307_a(var23[0] - var15[0]) * var14 + 180.0F) * 3.1415927F / 180.0F;
         this.field_40312_b.field_1407_d = var24 + (float)(var23[1] - var15[1]) * 3.1415927F / 180.0F * var14 * 5.0F;
         this.field_40312_b.field_1405_f = this.func_40307_a(var23[0] - (double)var17) * 3.1415927F / 180.0F * var14;
         this.field_40312_b.field_1409_b = var11;
         this.field_40312_b.field_1408_c = var12;
         this.field_40312_b.field_1410_a = var13;
         var11 = (float)((double)var11 + Math.sin((double)this.field_40312_b.field_1407_d) * 10.0D);
