   ...
   public boolean func_1222_j(Block p_1222_1_, int p_1222_2_, int p_1222_3_, int p_1222_4_) {
      ...
      if(!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
         ...
         if(this.field_1773_d || var11) {
            ...
            float var65 = 1.0F;
            var5.func_987_a(var14 * var65, var14 * var65, var14 * var65);
         ...
         for(var34 = 0; var34 < 4; ++var34) {
            ...
            if(this.field_1773_d || var12[var34]) {
               ...
               var5.func_35835_b(p_1222_1_.func_35275_c(this.field_1772_a, var64, p_1222_3_, var37));
               float var63 = 1.0F;
               if(var34 < 2) {
                  var63 *= var16;
               } else {
