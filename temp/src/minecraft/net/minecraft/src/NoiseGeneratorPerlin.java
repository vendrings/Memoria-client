      ...
      if(p_805_9_ == 1) {
         ...
         for(int var30 = 0; var30 < p_805_8_; ++var30) {
            ...
            for(var37 = 0; var37 < p_805_10_; ++var37) {
               ...
               int var64 = this.field_1189_d[var19] + var41;
               int var69 = this.field_1189_d[var34 + 1] + 0;
               var22 = this.field_1189_d[var69] + var41;
               var72 = this.func_804_b(var35, this.func_4110_a(this.field_1189_d[var64], var31, var38), this.func_803_a(this.field_1189_d[var22], var31 - 1.0D, 0.0D, var38));
               var71 = this.func_804_b(var35, this.func_803_a(this.field_1189_d[var64 + 1], var31, 0.0D, var38 - 1.0D), this.func_803_a(this.field_1189_d[var22 + 1], var31 - 1.0D, 0.0D, var38 - 1.0D));
               double var79 = this.func_804_b(var42, var72, var71);
               var10001 = var77++;
               p_805_1_[var10001] += var79 * var74;
            }
         }
            ...
            for(int var44 = 0; var44 < p_805_10_; ++var44) {
               ...
               for(int var51 = 0; var51 < p_805_9_; ++var51) {
                  ...
                  if(var51 == 0 || var55 != var22) {
                     var22 = var55;
                     int var68 = this.field_1189_d[var41] + var55;
                     int var73 = this.field_1189_d[var68] + var48;
                     int var70 = this.field_1189_d[var68 + 1] + var48;
                     int var76 = this.field_1189_d[var41 + 1] + var55;
                     var77 = this.field_1189_d[var76] + var48;
                     int var75 = this.field_1189_d[var76 + 1] + var48;
                     var29 = this.func_804_b(var42, this.func_803_a(this.field_1189_d[var73], var38, var52, var45), this.func_803_a(this.field_1189_d[var77], var38 - 1.0D, var52, var45));
                     var31 = this.func_804_b(var42, this.func_803_a(this.field_1189_d[var70], var38, var52 - 1.0D, var45), this.func_803_a(this.field_1189_d[var75], var38 - 1.0D, var52 - 1.0D, var45));
                     var33 = this.func_804_b(var42, this.func_803_a(this.field_1189_d[var73 + 1], var38, var52, var45 - 1.0D), this.func_803_a(this.field_1189_d[var77 + 1], var38 - 1.0D, var52, var45 - 1.0D));
                     var35 = this.func_804_b(var42, this.func_803_a(this.field_1189_d[var70 + 1], var38, var52 - 1.0D, var45 - 1.0D), this.func_803_a(this.field_1189_d[var75 + 1], var38 - 1.0D, var52 - 1.0D, var45 - 1.0D));
                  }
