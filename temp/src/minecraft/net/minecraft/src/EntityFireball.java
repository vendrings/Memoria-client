      ...
      if(!this.field_615_ag.field_1026_y && (this.field_9397_j != null && this.field_9397_j.field_646_aA || !this.field_615_ag.func_630_d((int)this.field_611_ak, (int)this.field_610_al, (int)this.field_609_am))) {
         ...
         if(this.func_27013_ag()) {
            for(int var19 = 0; var19 < 4; ++var19) {
               float var18 = 0.25F;
               this.field_615_ag.func_694_a("bubble", this.field_611_ak - this.field_608_an * (double)var18, this.field_610_al - this.field_607_ao * (double)var18, this.field_609_am - this.field_606_ap * (double)var18, this.field_608_an, this.field_607_ao, this.field_606_ap);
            }
