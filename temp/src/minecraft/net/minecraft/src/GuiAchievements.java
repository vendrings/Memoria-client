...
public class GuiAchievements extends GuiScreen {
   ...
   protected void func_27109_b(int p_27109_1_, int p_27109_2_, float p_27109_3_) {
      ...
      for(var24 = 0; var24 < AchievementList.field_27388_e.size(); ++var24) {
         ...
         if(var26 >= -24 && var27 >= -24 && var26 <= 224 && var27 <= 155) {
            ...
            if(var35.func_27093_f()) {
               this.func_550_b(var42 - 2, var41 - 2, 26, 202, 26, 26);
            } else {
               this.func_550_b(var42 - 2, var41 - 2, 0, 202, 26, 26);
            }
            ...
            GL11.glEnable(2896);
            GL11.glEnable(2884);
            var37.func_161_a(this.field_945_b.field_6314_o, this.field_945_b.field_6315_n, var35.field_27097_d, var42 + 3, var41 + 3);
            GL11.glDisable(2896);
            if(!this.field_27120_x.func_27181_b(var35)) {
            ...
            if(p_27109_1_ >= var10 && p_27109_2_ >= var11 && p_27109_1_ < var10 + 224 && p_27109_2_ < var11 + 155 && p_27109_1_ >= var42 && p_27109_1_ <= var42 + 22 && p_27109_2_ >= var41 && p_27109_2_ <= var41 + 22) {
               var32 = var35;
            }
         }
      }
      ...
      if(var32 != null) {
         String var34 = StatCollector.func_25200_a(var32.func_44020_i());
         String var36 = var32.func_27090_e();
         var26 = p_27109_1_ + 12;
         var27 = p_27109_2_ - 4;
         if(this.field_27120_x.func_27181_b(var32)) {
            var42 = Math.max(this.field_6451_g.func_871_a(var34), 120);
            var41 = this.field_6451_g.func_27277_a(var36, var42);
            if(this.field_27120_x.func_27183_a(var32)) {
               var41 += 12;
            }

            this.func_549_a(var26 - 3, var27 - 3, var26 + var42 + 3, var27 + var41 + 3 + 12, -1073741824, -1073741824);
            this.field_6451_g.func_27278_a(var36, var26, var27 + 12, var42, -6250336);
            if(this.field_27120_x.func_27183_a(var32)) {
               this.field_6451_g.func_50103_a(StatCollector.func_25200_a("achievement.taken"), var26, var27 + var41 + 4, -7302913);
            }
         } else {
            var42 = Math.max(this.field_6451_g.func_871_a(var34), 120);
            String var39 = StatCollector.func_25199_a("achievement.requires", new Object[]{StatCollector.func_25200_a(var32.field_25076_c.func_44020_i())});
            var30 = this.field_6451_g.func_27277_a(var39, var42);
            this.func_549_a(var26 - 3, var27 - 3, var26 + var42 + 3, var27 + var30 + 12 + 3, -1073741824, -1073741824);
            this.field_6451_g.func_27278_a(var39, var26, var27 + 12, var42, -9416624);
         }

         this.field_6451_g.func_50103_a(var34, var26, var27, this.field_27120_x.func_27181_b(var32)?(var32.func_27093_f()?-128:-1):(var32.func_27093_f()?-8355776:-8355712));
      }
