...
public class Explosion {
   ...
   public void func_12248_a() {
      ...
      for(int var11 = 0; var11 < var9.size(); ++var11) {
         ...
         double var13 = var32.func_361_e(this.field_12256_b, this.field_12255_c, this.field_12254_d) / (double)this.field_12252_f;
         if(var13 <= 1.0D) {
            var15 = var32.field_611_ak - this.field_12256_b;
            var17 = var32.field_610_al - this.field_12255_c;
            var19 = var32.field_609_am - this.field_12254_d;
            double var35 = (double)MathHelper.func_1109_a(var15 * var15 + var17 * var17 + var19 * var19);
            var15 /= var35;
            var17 /= var35;
            var19 /= var35;
            double var34 = (double)this.field_12249_i.func_675_a(var31, var32.field_601_au);
            double var36 = (1.0D - var13) * var34;
            var32.func_396_a(DamageSource.field_35548_k, (int)((var36 * var36 + var36) / 2.0D * 8.0D * (double)this.field_12252_f + 1.0D));
            var32.field_608_an += var15 * var36;
            var32.field_607_ao += var17 * var36;
            var32.field_606_ap += var19 * var36;
         }
      }

      this.field_12252_f = var1;
      ArrayList var33 = new ArrayList();
      var33.addAll(this.field_12251_g);
   }
