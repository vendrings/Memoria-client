      ...
      if(this.field_6388_l > 0) {
         ...
         if(!this.field_4091_h) {
            ...
            for(int var29 = 0; var29 < var27; ++var29) {
               double var14 = this.field_601_au.field_1697_b + (this.field_601_au.field_1702_e - this.field_601_au.field_1697_b) * (double)(var29 + 0) / (double)var27 - 0.125D + 0.125D;
               double var16 = this.field_601_au.field_1697_b + (this.field_601_au.field_1702_e - this.field_601_au.field_1697_b) * (double)(var29 + 1) / (double)var27 - 0.125D + 0.125D;
            ...
            if(var26 > 0.0D) {
               if(this.field_4088_k > 0) {
                  ...
                  if(this.field_9312_bd.nextInt(var28) == 0) {
