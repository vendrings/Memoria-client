   ...
   public void func_425_j() {
      ...
      if(this.field_9337_J <= 0) {
         ...
         if(this.field_615_ag.field_1026_y) {
            ...
            Vec3D var40 = Vec3D.func_1248_b((double)MathHelper.func_1106_a(this.field_605_aq * 3.1415927F / 180.0F), this.field_607_ao, (double)(-MathHelper.func_1114_b(this.field_605_aq * 3.1415927F / 180.0F))).func_1252_b();
            float var17 = (float)(var40.func_35612_b(var15) + 0.5D) / 1.5F;
            if(var17 < 0.0F) {
               var17 = 0.0F;
            }
            ...
            float var24 = (float)(var23.func_35612_b(var40) + 1.0D) / 2.0F;
         ...
         float var28 = -MathHelper.func_1106_a(var26);
         float var5 = this.field_605_aq * 3.1415927F / 180.0F;
         float var27 = MathHelper.func_1106_a(var5);
         float var7 = MathHelper.func_1114_b(var5);
         this.field_40171_aq.func_370_e_();
         this.field_40171_aq.func_365_c(this.field_611_ak + (double)(var27 * 0.5F), this.field_610_al, this.field_609_am - (double)(var7 * 0.5F), 0.0F, 0.0F);
         this.field_40175_au.func_370_e_();
         this.field_40175_au.func_365_c(this.field_611_ak + (double)(var7 * 4.5F), this.field_610_al + 2.0D, this.field_609_am + (double)(var27 * 4.5F), 0.0F, 0.0F);
         this.field_40174_av.func_370_e_();
         this.field_40174_av.func_365_c(this.field_611_ak - (double)(var7 * 4.5F), this.field_610_al + 2.0D, this.field_609_am - (double)(var27 * 4.5F), 0.0F, 0.0F);
         if(!this.field_615_ag.field_1026_y) {
            this.func_41007_az();
         }
         ...
         var33 = MathHelper.func_1106_a(this.field_605_aq * 3.1415927F / 180.0F - this.field_9338_aj * 0.01F);
         float var32 = MathHelper.func_1114_b(this.field_605_aq * 3.1415927F / 180.0F - this.field_9338_aj * 0.01F);
         this.field_40177_ap.func_370_e_();
         this.field_40177_ap.func_365_c(this.field_611_ak + (double)(var33 * 5.5F * var3), this.field_610_al + (var9[1] - var30[1]) * 1.0D + (double)(var28 * 5.5F), this.field_609_am - (double)(var32 * 5.5F * var3), 0.0F, 0.0F);
         ...
         for(int var29 = 0; var29 < 3; ++var29) {
            ...
            float var34 = this.field_605_aq * 3.1415927F / 180.0F + this.func_40159_b(var35[0] - var30[0]) * 3.1415927F / 180.0F * 1.0F;
            float var37 = MathHelper.func_1106_a(var34);
            float var38 = MathHelper.func_1114_b(var34);
            float var36 = 1.5F;
            float var39 = (float)(var29 + 1) * 2.0F;
            var31.func_370_e_();
            var31.func_365_c(this.field_611_ak - (double)((var27 * var36 + var37 * var39) * var3), this.field_610_al + (var35[1] - var30[1]) * 1.0D - (double)((var39 + var36) * var28) + 1.5D, this.field_609_am + (double)((var7 * var36 + var38 * var39) * var3), 0.0F, 0.0F);
         }
