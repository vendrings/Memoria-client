...
public abstract class GuiContainer extends GuiScreen {
   ...
   public void func_571_a(int p_571_1_, int p_571_2_, float p_571_3_) {
      ...
      for(int var20 = 0; var20 < this.field_973_i.field_20122_e.size(); ++var20) {
         Slot var23 = (Slot)this.field_973_i.field_20122_e.get(var20);
         this.func_590_a(var23);
         if(this.func_20081_a(var23, p_571_1_, p_571_2_)) {
            var6 = var23;
            GL11.glDisable(2896);
            GL11.glDisable(2929);
            int var9 = var23.field_20006_b;
            var10 = var23.field_20008_c;
      ...
      if(var21.func_20075_i() == null && var6 != null && var6.func_20005_c()) {
         ItemStack var22 = var6.func_777_b();
         List var24 = var22.func_40712_q();
         if(var24.size() > 0) {
            var10 = 0;
            ...
            for(int var18 = 0; var18 < var24.size(); ++var18) {
               ...
               if(var18 == 0) {
                  var19 = "\u00a7" + Integer.toHexString(var22.func_40707_s().field_40535_e) + var19;
               } else {
                  var19 = "\u00a77" + var19;
               }
