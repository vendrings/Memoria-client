...
public class CraftingManager {
   ...
   void func_1121_a(ItemStack p_1121_1_, Object ... p_1121_2_) {
      ...
      for(var12 = new HashMap(); var4 < p_1121_2_.length; var4 += 2) {
         ...
         if(p_1121_2_[var4 + 1] instanceof Item) {
            var14 = new ItemStack((Item)p_1121_2_[var4 + 1]);
         } else if(p_1121_2_[var4 + 1] instanceof Block) {
            var14 = new ItemStack((Block)p_1121_2_[var4 + 1], 1, -1);
         } else if(p_1121_2_[var4 + 1] instanceof ItemStack) {
            var14 = (ItemStack)p_1121_2_[var4 + 1];
         }
      ...
      for(int var16 = 0; var16 < var5 * var6; ++var16) {
         ...
         if(var12.containsKey(Character.valueOf(var10))) {
            var15[var16] = ((ItemStack)var12.get(Character.valueOf(var10))).func_1102_e();
         } else {
            var15[var16] = null;
         }
      }

      this.field_1662_b.add(new ShapedRecipes(var5, var6, var15, p_1121_1_));
   }
   ...
   public ItemStack func_21188_a(InventoryCrafting p_21188_1_) {
      ...
      if(var2 == 2 && var3.field_1617_c == var4.field_1617_c && var3.field_1615_a == 1 && var4.field_1615_a == 1 && Item.field_233_c[var3.field_1617_c].func_25007_g()) {
         Item var11 = Item.field_233_c[var3.field_1617_c];
         int var10 = var11.func_197_c() - var3.func_21179_h();
         int var7 = var11.func_197_c() - var4.func_21179_h();
         int var8 = var10 + var7 + var11.func_197_c() * 10 / 100;
         int var9 = var11.func_197_c() - var8;
         if(var9 < 0) {
            var9 = 0;
         }
         ...
         for(var5 = 0; var5 < this.field_1662_b.size(); ++var5) {
            IRecipe var12 = (IRecipe)this.field_1662_b.get(var5);
            if(var12.func_21135_a(p_21188_1_)) {
               return var12.func_21136_b(p_21188_1_);
            }
         }
