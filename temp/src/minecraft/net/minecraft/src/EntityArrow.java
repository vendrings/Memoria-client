      ...
      if(this.field_9315_g) {
         ...
         if(var3 != null) {
            if(var3.field_1168_g != null) {
               ...
               if(this.field_682_g == null) {
                  var22 = DamageSource.func_35535_a(this, this);
               } else {
                  var22 = DamageSource.func_35535_a(this, this.field_682_g);
               }
               ...
               if(var3.field_1168_g.func_396_a(var22, var20)) {
                  if(var3.field_1168_g instanceof EntityLiving) {
                     ++((EntityLiving)var3.field_1168_g).field_35172_bP;
                     if(this.field_46027_au > 0) {
                        float var21 = MathHelper.func_1109_a(this.field_608_an * this.field_608_an + this.field_606_ap * this.field_606_ap);
                        if(var21 > 0.0F) {
                           var3.field_1168_g.func_348_f(this.field_608_an * (double)this.field_46027_au * 0.6000000238418579D / (double)var21, 0.1D, this.field_606_ap * (double)this.field_46027_au * 0.6000000238418579D / (double)var21);
                        }
                     }
                  }
         ...
         if(this.func_27013_ag()) {
            for(int var25 = 0; var25 < 4; ++var25) {
               float var24 = 0.25F;
               this.field_615_ag.func_694_a("bubble", this.field_611_ak - this.field_608_an * (double)var24, this.field_610_al - this.field_607_ao * (double)var24, this.field_609_am - this.field_606_ap * (double)var24, this.field_608_an, this.field_607_ao, this.field_606_ap);
            }

            var23 = 0.8F;
         }

         this.field_608_an *= (double)var23;
         this.field_607_ao *= (double)var23;
         this.field_606_ap *= (double)var23;
